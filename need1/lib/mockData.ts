import type { User, Request, Offer, Thread, Message, SafeSpot, FlashDrop } from "../types"
...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    id: "4",
    type: "eco",
    title: "Eco Impact Badge",
    message: "You earned an Eco Impact badge for sustainable service",
    isRead: true,
